...
public class Constants {
    ...
    // FIXME: please change to your valid api domain for test, for example: jbex.cloud
    public static final String BASE_DOMAIN = "";

    // REST api url format: https://api.BASE_DOMAIN
    // for example: https://api.jbex.cloud
    ...
    // for example: wss://wsapi.jbex.cloud/openapi/quote/ws/v1
    ...
    // for example: wss://wsapi.jbex.cloud/openapi/ws
